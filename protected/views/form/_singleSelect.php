...
<h3><?php echo ($update)? "修改" : "新增"; ?>單選按鈕</h3>
...
<div class="form-group">
		...
		<div id="single-select-input-group">
			...
			?>
				<div class="single-select-input-box">
					<input type="radio" name="optionsRadios" class="radios" value="option1" disabled>
	...
	<div class="single-select-input-box-add single-select-add-btn">
		<input type="radio" name="optionsRadios"  class="radios single-select-add-btn" value="option1" disabled>
	...
	<div class="single-select-input-box-other single-select-other">
		<input type="radio" name="optionsRadios"  class="radios single-select-other-btn" value="other" disabled>
	...
	$(function() {
		...
		$("#getLayout").click(function() {
			...
			if($("#input-title").val().length > 0){
				$.ajax({
					type: 'POST',
					url:"getLayout?type=singleSelect&pid=<?php echo $_GET['pid']; ?>",
					data: data,
