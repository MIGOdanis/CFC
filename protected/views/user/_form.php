...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<?php if($model->isNewRecord):?>
		<div class="form-group">
			...
			<?php echo $form->textField($model,'username',array('size'=>60,'maxlength'=>128 , "class"=>"form-control" , "placeholder"=>"帳號")); ?>
			<p class="text-danger"><?php echo $form->error($model,'username'); ?></p>
	...
	<div class="form-group">
		<label><?php echo $form->labelEx($model,'nick_name'); ?></label>
		<?php echo $form->textField($model,'nick_name',array('size'=>60,'maxlength'=>128 , "class"=>"form-control" , "placeholder"=>"暱稱")); ?>
		<p class="text-danger"><?php echo $form->error($model,'nick_name'); ?></p>
	</div>	
