...
function newPage(){
    ...
    $fileName = md5(time().$folde) . ".php";
    $urlFile = $folder . "/" . $fileName;
    $fileName = $folder . DIRECTORY_SEPARATOR . $fileName;
    if (is_file($fileName)) {
...
function getCode(){
	return file_get_contents($_POST['type']);
}
...
<html class="modern" lang="zh">
	<head>
		...
		<!-- Bootstrap core CSS -->
		<link href="../asssets/bootstrap/css/bootstrap.min.css" rel="stylesheet">
		<!-- Bootstrap theme -->
		<link href="../asssets/bootstrap/css/bootstrap-theme.min.css" rel="stylesheet">
	...
	<body>
		<div id="main">
			...
			<div class="main">
				...
				?>
				<form enctype="multipart/form-data" action="index.php?make=1" method="POST">
			...
			<div id="bottom">
				V1.0b<br>
				Copyright © 2012 Powered by ClickForce. All rights reserved.
			</div>
		</div>
	</body>
</html>
